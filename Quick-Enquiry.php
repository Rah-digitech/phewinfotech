...
$message1="<font><b>Quick Enquiry </b></font><br>";
...
$res= mail($email,'Quick Enquiry ',$message1,$headers);
...
$msg='<h2 style="color:#FF0000">Please Enter Correct Captcha Code. </h2>';
}
?>
<!DOCTYPE html>
